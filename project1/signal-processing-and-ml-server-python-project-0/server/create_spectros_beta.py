...
def spectrogram_generator_cwt(signal_array):

    dataset_folder_path = '/home/axis/Documents/project1/signal-processing-and-ml-server-python-project-0/server/test_spectrograms'
    ...
    try:
        ...
        def plot_spectrogram(time, frequencies, spectrogram,
            ...
            #             cmap='jet', vmin=0, vmax=0.0001)
            plt.imshow(spectrogram, aspect='auto', extent=[time.min(), time.max(), frequencies.min(), frequencies.max()],
                        cmap='jet', vmin=0.005, vmax=0.08)
            print("imshow")
            plt.axis('off')
            ...
            output_file_path = f"{dataset_folder_path}/{random_string_save}.jpg"
        ...
        plot_string = f'{random_string}'

        generated_spectrogram  = spectrogram_generator_alpha(raw_signal, plot_string)

        print("AFTER SPECTROGRAM")

        print(len(generated_spectrogram[2]))
...
if __name__ == '__main__':
       ...
       folder_path = '/home/axis/Documents/project1/signal-processing-and-ml-server-python-project-0/server/recorded_data'
       ...
       for filename in os.listdir(folder_path):
           if filename.endswith('.csv'):
               ...
               spectro = spectrogram_generator_cwt(raw_data)
